...
resource "null_resource" "tf_env" {
  provisioner "local-exec" {
    ...
    echo_export "TF_VAR_deploy_type" "kubernetes"
    echo_export "TF_VAR_language" "python"
    echo_export "TF_VAR_ui_type" "html"
    # echo_export "OCI_STARTER_CREATION_DATE" "2026-03-19-16-49-21-676849"
...
resource "null_resource" "build_deploy" {
  ...
  depends_on = [
    ...
    oci_containerengine_addon.starter_oke_addon_certmanager,
    oci_containerengine_addon.starter_oke_addon_wlsoperator,
    oci_containerengine_cluster.starter_oke,
    oci_containerengine_node_pool.starter_node_pool,
